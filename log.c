...
void register_log (FILE *f, int pc, int32_t reg[32])
{
    int i;
...
void log_main (FILE *f, int pc, int32_t reg[32], float f_reg[32], int32_t mem[100000], char *option)
{
    register_log(f, pc, reg);
